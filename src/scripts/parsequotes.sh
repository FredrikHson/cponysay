...
function Cfile
{
    ...
    echo 'unsigned char *quotes_mute[] = {mute};'
    echo "unsigned short numquotes_mute = 1;"
}
function Hfile
{
    echo "/* Auto Generated file DO NOT edit */"
    ...
    echo "extern unsigned char *quotes_mute[];"
    for name in ${uniqueponies[@]}; do
        echo "extern unsigned short numquotes_${name};"
    done
    echo "extern unsigned short numquotes_mute;"
}
Cfile > quotes.c
Hfile > quotes.h
